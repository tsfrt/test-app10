...
```json
{
  "apiBinding" : false,
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=tsfrt&repo=test-app10",
  "messagingBinding" : false,
  "oracleBinding" : true,
  "projectName" : "test-app10"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ Debug src/src/db/+page.server.ts matched [**/*] -> included
┃ ┃ ┃ ┃ ┃ ┃ Debug src/src/db/+page.svelte matched [**/*] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ Debug src/src/db/+page.server.ts didn't match [package.json, **.md, workload.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ Debug src/src/db/+page.svelte didn't match [package.json, **.md, workload.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/src/db/+page.server.ts didn't match [bindings/**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/src/db/+page.svelte didn't match [bindings/**] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [accelerator-placeholder-name->test-app10]
...
┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/src/db/+page.server.ts', will use the one appearing last 
...
┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/src/db/+page.svelte', will use the one appearing last 
